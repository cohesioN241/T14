if GetLocale() == "deDE" then
	...
	TukuiL.option_unitframes_focus = "Aktiviere Fokus Ziel"
	TukuiL.option_unitframes_healthvertical = "Aktiviere die vertikalen Gesundheitsbalken"
	TukuiL.option_unitframes_healthdeficit = "Aktiviere das Defizit der Gesundheit"
	TukuiL.option_unitframes_hidepower = "Verstecke die Ressourcenleiste"
	TukuiL.option_unitframes_onlyselfdebuffs = "Zeige ausschließlich deine eigenen Schwächungszauber"
	TukuiL.option_unitframes_onlyselfbuffs = "Zeige ausschließlich deine eigenen Stärkungszauber"
	TukuiL.option_unitframes_buffrows = "Anzahl der Reihen der Stärkungszauber"
