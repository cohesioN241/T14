...
TukuiL.option_unitframes_aurawatch = "Enable PVE raid Aura Watch (Heal Only)"
...
TukuiL.option_unitframes_healthvertical = "Show health bar vertically for Heal layout"
...
TukuiL.option_unitframes_focus = "Enable Focus target"
TukuiL.option_unitframes_healthdeficit = "Enable the health deficit"
TukuiL.option_unitframes_hidepower = "Hide the Powerbar"
TukuiL.option_unitframes_onlyselfbuffs = "Show only your buffs"
TukuiL.option_unitframes_buffrows = "Number of buff rows"
TukuiL.option_unitframes_debuffrows = "Number of debuff rows"
TukuiL.option_unitframes_dcbclasscolor = "Enable the classcolored castbar"
TukuiL.option_unitframes_sortname = "Sort group by name"
TukuiL.option_unitframes_focusdebuffs = "Show Focus Debuffs"
TukuiL.option_unitframes_focusbuffs = "Show Focus Buffs"
TukuiL.option_unitframes_healthColor = "Choose the color of healthbar"
TukuiL.option_unitframes_cbcustomcolor = "Choose the color of the castbar"
TukuiL.option_unitframes_debuffHighlightFilter = "Enable the debuff highlight on the unitframes"
TukuiL.option_unitframes_healthBgColor = "Choose the Color of the background of the unitframes"
TukuiL.option_unitframes_deathknight = "Enable the runebar for deathknight"
TukuiL.option_unitframes_warlock = "Enable the soul shard bar for warlock"
TukuiL.option_unitframes_shaman = "Enable the totembar for shaman"
TukuiL.option_unitframes_druid = "Enable the solar-/lunarbar for druid"
TukuiL.option_unitframes_paladin = "Enable the holy powerbar for paladin"
TukuiL.option_unitframes_playerHighlight = "Enable the debuff highlighting on the player"
TukuiL.option_unitframes_style = "Unitframe Style (Eclipse or Cohesion)"
TukuiL.option_unitframes_gradienthealth = "Change raid health color based on health percent (Heal Only)"
TukuiL.option_unitframes_mouseoverhighlight = "Enable mouseover-highlight (Heal Only)"
TukuiL.option_unitframes_dpsunitdebuffwatch = "Enable PVE raid Aura Watch for DPS (Requires Heal Aura Watch Enabled)"
TukuiL.option_unitframes_raiddebuffstime = "Enable timer for debuffs on raid frames"
...
TukuiL.option_combo_warrior = "Enable warrior combos"
TukuiL.option_combo_paladin = "Enable paladin combos"
TukuiL.option_combo_shaman = "Enable shaman combos"
TukuiL.option_combo_dknight = "Enable death knight combos"
TukuiL.option_combo_mage = "Enable mage combos"
TukuiL.option_combo_druid = "Enable druid combos"
TukuiL.option_combo_display = "Enable combo module"
TukuiL.option_combo_hunter = "Enable hunter combos"
TukuiL.option_combo_warlock = "Enable warlock combos"
TukuiL.option_combo_priest = "Enable priest combos"

-- other
TukuiL.option_others_autoquest = "Enable auto-quest feature"