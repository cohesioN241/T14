...
local function LoadSkin()
	...
	CalendarCreateEventInviteList:SetTemplate("Skinning")
	...
	CalendarCreateEventDescriptionContainer:SetTemplate("Skinning")
	...
	CalendarEventPickerFrame:SetTemplate("Skinning")
