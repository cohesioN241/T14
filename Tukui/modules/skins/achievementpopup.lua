	...
	local function SkinAchievePopUp()
		for i = 1, MAX_ACHIEVEMENT_ALERTS do
			...
			if frame then
				...
				-- Text
				_G["AchievementAlertFrame"..i.."Unlocked"]:SetFont(C.media.caith, 12)
				_G["AchievementAlertFrame"..i.."Unlocked"]:SetTextColor(1, 1, 1)
				_G["AchievementAlertFrame"..i.."Name"]:SetFont(C.media.caith, 14)
				...
				if not _G["AchievementAlertFrame"..i.."IconTexture"].b then
					...
					_G["AchievementAlertFrame"..i.."IconTexture"].b:SetTemplate("Skinning")
		...
		for i = 1, DUNGEON_COMPLETION_MAX_REWARDS do
			...
			if frame then
				...
				if not _G["DungeonCompletionAlertFrame"..i.."DungeonTexture"].b then
					...
					_G["DungeonCompletionAlertFrame"..i.."DungeonTexture"].b:SetTemplate("Skinning")
