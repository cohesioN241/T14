...
local function LoadSkin()
	...
	hooksecurefunc("AchievementFrameSummary_UpdateAchievements", function()
		for i=1, ACHIEVEMENTUI_MAX_SUMMARY_ACHIEVEMENTS do
			...
			if not frame.backdrop then
				...
				_G["AchievementFrameSummaryAchievement"..i.."Icon"]:SetTemplate("Skinning")
	...
	for i=1, 7 do
		...
		_G["AchievementFrameAchievementsContainerButton"..i.."Icon"]:SetTemplate("Skinning")
		...
		_G["AchievementFrameAchievementsContainerButton"..i.."Tracked"]:SetTemplate("Skinning")
	...
	for _, compare in pairs(compares) do
		for i=1, 9 do
			...
			_G[frame.."Icon"]:SetTemplate("Skinning")
