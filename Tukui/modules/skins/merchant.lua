...
local function LoadSkin()
	...
	MerchantBuyBackItemItemButton:SetTemplate("Skinning", true)
	...
	MerchantRepairItemButton:SetTemplate("Skinning", true)
	...
	MerchantGuildBankRepairButton:SetTemplate("Skinning", true)
	...
	MerchantRepairAllButton:SetTemplate("Skinning", true)
