...
local function LoadSkin()
	...
	SendMailScrollFrame:SetTemplate("Skinning")
	...
	OpenMailScrollFrame:SetTemplate("Skinning")
	...
	OpenMailLetterButton:SetTemplate("Skinning", true)
	...
	OpenMailMoneyButton:SetTemplate("Skinning", true)
