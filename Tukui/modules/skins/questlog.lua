...
local function LoadSkin()
	...
	for i=1, MAX_NUM_ITEMS do
		...
		_G["QuestInfoItem"..i]:SetTemplate("Skinning")
	...
	QuestInfoSkillPointFrame:SetTemplate("Skinning")
	...
	QuestInfoItemHighlight:SetTemplate("Skinning")
	...
	QuestLogFrame:HookScript("OnShow", function()
		...
		QuestLogScrollFrame:SetTemplate("Skinning")
		QuestLogDetailScrollFrame:SetTemplate("Skinning")
	end)
end	
