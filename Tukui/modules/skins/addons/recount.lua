...
local function SkinFrame(frame)
	...
	frame.Title:SetFont(unpack(T.Fonts.dFont.setfont))
	...
	frame.CloseButton.t:SetFont(unpack(T.Fonts.dFont.setfont))
...
Recount.UpdateBarTextures = function(self)
	for k, v in pairs(Recount.MainWindow.Rows) do
		...
		v.LeftText:SetFont(unpack(T.Fonts.dFont.setfont))
		v.RightText:SetPoint("RIGHT", -4, 1)
		v.RightText:SetFont(unpack(T.Fonts.dFont.setfont))
	end
end
...
Recount.MainWindow.RightButton:FontString("text", C.media.pixel_font, 12, "MONOCHROME")
...
Recount.MainWindow.LeftButton:FontString("text", C.media.pixel_font, 12, "MONOCHROME")
...
Recount.MainWindow.ResetButton:FontString("text", C.media.pixel_font, 12, "MONOCHROME")
...
Recount.MainWindow.FileButton:FontString("text", C.media.pixel_font, 12, "MONOCHROME")
...
Recount.MainWindow.ConfigButton:FontString("text", C.media.pixel_font, 12, "MONOCHROME")
...
Recount.MainWindow.ReportButton:FontString("text", C.media.pixel_font, 12, "MONOCHROME")
