...
TukuiWatchFrameAnchor.text = T.SetFontString(TukuiWatchFrameAnchor, unpack(T.Fonts.movers.setfont))
...
TukuiWatchFrameAnchor:Point("TOPRIGHT", UIParent, 0, -230)
...
local function setup()	
	...
	WatchFrameCollapseExpandButton.t:SetFont(unpack(T.Fonts.movers.setfont))
