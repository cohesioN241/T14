...
if not C["datatext"].maptime then return end
...
local Stat = CreateFrame("Frame", "TukuiMinimapTime", UIParent)
Stat:CreatePanel(Stat, 73, 23, "TOP", Minimap, "BOTTOM", 0, 10)
